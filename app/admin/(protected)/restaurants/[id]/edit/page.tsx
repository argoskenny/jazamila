...
import { getActiveCuisineTypeOptions, getAuxiliaryTagOptions, getRestaurantForAdmin } from "@/lib/domain/restaurants";
...
export default async function EditRestaurantPage({ params }: Props) {
  ...
  return (
    <div className="form-grid">
      ...
      <RestaurantForm action={updateRestaurantAction} restaurant={restaurant} cuisineTypes={cuisineTypes} auxiliaryTags={auxiliaryTags} submitLabel="儲存變更" />
    </div>
  );
}

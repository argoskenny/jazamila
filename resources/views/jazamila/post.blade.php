...
<body ontouchstart="">
    ...
    <div class="main" id="post">
        <div class="container">
            ...
            <div class="main_title reveal">餐廳分享</div>
            <div class="main_text reveal">有好吃的？請推薦給大家吧！</div>
            <form id="post_form" name="post_form" action="save_post_data" method="post" enctype="multipart/form-data"
                role="form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="res_area_num" name="res_area_num" maxlength="3"
                        value=""> - <input type="text" class="form-control" name="res_tel_num" id="res_tel_num"
                        maxlength="8" value="">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control res_time" name="open_time_hr" id="open_time_hr"
                        maxlength="2" value="" /> ：
                    <input type="text" class="form-control res_time" name="open_time_min" id="open_time_min"
                        maxlength="2" value="" />
                    至 <input type="text" class="form-control res_time" name="close_time_hr" id="close_time_hr"
                        maxlength="2" value="" /> ：
                    <input type="text" class="form-control res_time" name="close_time_min" id="close_time_min"
                        maxlength="2" value="" />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control blogname" id="res_blogname1" name="res_blogname1"
                    ...
                    <input type="text" class="form-control bloglink" id="res_bloglink1" name="res_bloglink1"
    ...
    <div class="share" id="post_faq">
        <div class="container">
            <div class="faq_title reveal">餐廳分享說明</div>
            <div class="faq_q reveal">Q1. 餐廳分享？這是在幹嘛？</div>
            <div class="faq_a reveal">A1. 這裡是為了讓你分享餐廳資訊用的。</div>
            ...
            <div class="faq_a">A4.
                相信你一定有注意到，這裡的餐廳資料有點少。你的分享將會豐富這裡的餐廳資訊，並解決更多人不知道要吃什麼的窘境。而在餐廳的介紹頁面，可以放上你個人部落格的食記連結，介紹這家餐廳。當然，如果沒有部落格也可以分享。
            </div>

...
<head>
    ...
    <title>{{ $title ?? 'JAZAMILA - 餐廳列表' }}</title>
    <base href="{{ url('/') }}/" />
            ...
            <div class="col-xs-12 col-sm-3 option_title">
                ...
                <div id="option_choose">
                    <div class="option_select">
                        <b>吃哪邊？</b>
                        <input type="hidden" id="foodwhere_region" name="foodwhere_region"
                            value="{{ $url_region }}">
                        <div class="btn-group foodwhere_region">
                            <button type="button" id="show_option_region" class="btn btn-default dropdown-toggle"
                                data-toggle="dropdown">
                                {{ $region_show = $url_region == 0 ? '都可以' : $config['region'][$url_region] }} <span
                                    class="caret"></span>
                            </button>
                        ...
                        <div class="btn-group foodwhere_section">
                            <button type="button" id="show_option_section" class="btn btn-default dropdown-toggle"
                                data-toggle="dropdown">
                    ...
                    <div class="option_select">
                        ...
                        <div class="btn-group foodmoney_min">
                            <button type="button" id="show_option_min" class="btn btn-default dropdown-toggle"
                                data-toggle="dropdown">
                                {{ $url_minmoney = $url_minmoney == 0 ? '0元' : $url_minmoney . '元左右' }} <span
                                    class="caret"></span>
                            </button>
                            <ul class="dropdown-menu" role="menu">
                        ...
                        <div class="btn-group foodmoney_max">
                            <button type="button" id="show_option_max" class="btn btn-default dropdown-toggle"
                                data-toggle="dropdown">
                                {{ $url_maxmoney = $url_maxmoney == 0 ? '無上限' : $url_maxmoney . '元左右' }} <span
                                    class="caret"></span>
                            </button>
                            <ul class="dropdown-menu" role="menu">
                    ...
                    <div class="option_select">
                        ...
                        <div class="btn-group foodtype">
                            <button type="button" id="show_option_type" class="btn btn-default dropdown-toggle"
                                data-toggle="dropdown">
                                {{ $foodtype_show = $url_type == 0 ? '都可以' : $config['foodtype'][$url_type] }} <span
                                    class="caret"></span>
                            </button>
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="javascript:void(0);" a_type="0">都可以</a></li>

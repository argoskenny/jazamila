...
<head>
	...
	<meta name="description" content="{{ $res_data['res_name'] }}的餐廳詳細資料" />
		...
		<?php }?>
			<div class="col-xs-12 col-md-6 res_detail">
				<div class="basic_info">
					<span>餐廳名稱：</span><a href="http://www.google.com.tw/search?q={{ $res_data['res_name'] }}" target="_blank" id="name_remind">{{ $res_data['res_name'] }}</a><br />
					...
					?><br />
					<span>餐廳地址：</span><a href="http://maps.google.com/maps?q={{ $res_data['res_region'].$res_data['res_section'].$res_data['res_address'] }}" target="_blank" id="map_remind">{{ $res_data['res_region'].$res_data['res_section'].$res_data['res_address'] }}</a><br />
...
<?php 	echo $res_data['res_note'];
	...
	<div class="main">
		<div class="container">
			...
			<div class="col-lg-12">
				<a href="listdata/{{ $list_record }}"><button type="button" id="back_to_list" class="btn btn-primary btn-lg">返回列表</button></a>
			</div>
		</div>
	</div>
	<div class="footer">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<?php foreach ($restuarant as $res_data): ?>
					<button type="button" class="btn blog_btn" onclick="blog_submit('{{ $res_data['id'] }}');">送出</button>
					<?php endforeach ?>
